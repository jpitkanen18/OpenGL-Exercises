...
const char *fragmentShaderSource2 = 
	...
	"void main()\n"
 	"{\n"
    "FragColor = vec4(1.00, 0.84, 0.05, 1.0);\n"
	"}\n";
...
const char *fragmentShaderSource3 = 
	...
	"void main()\n"
 	"{\n"
    "FragColor =vec4(1.00, 0.00, 0.83, 1.0);\n"
	"}\n";
...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(800, 600, "Prisma Simulator 2028", NULL, NULL);
	if (window == NULL)
	{
	...
	unsigned int VAO2, VBO2; // Vertex Array Object & Vertex Buffer Object
	unsigned int VAO3, VBO3; // Vertex Array Object & Vertex Buffer Object
